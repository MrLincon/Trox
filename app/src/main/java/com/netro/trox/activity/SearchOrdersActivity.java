...
public class SearchOrdersActivity extends AppCompatActivity {
    ...
    public String item_id, order_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = orderData.orderBy("timestamp", Query.Direction.ASCENDING).whereEqualTo("order_id",order_id);
        ...
        adapter.setOnItemClickListener(new OrderDataAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot) {
                ...
                Intent intent = new Intent(SearchOrdersActivity.this, TrackOrdersActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SearchOrdersActivity.this, MainActivity.class));
                finish();
            }
        });
